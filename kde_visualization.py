...
def create_kde_contour_map(x, y, resolution=100):
...
def visualize_kde_contour(xx, yy, density):
    ...
    contour_lines = plt.contour(xx, yy, density, levels=10, colors='black', alpha=0.3, linewidths=0.5)
...
def main():
    ...
    # KDE Contour Mapを作成
    print("KDE密度推定を実行中...")
    xx, yy, density = create_kde_contour_map(x, y, resolution=100)
